...
conn = sqlite3.connect(pjoin(str(BASE_DIR), "stats_db.sqlite3"))
c = conn.cursor()
...
create_query = """CREATE TABLE IF NOT EXISTS sdata (
    ...
    Sprint_Efforts number,
    Zone_1_Distance number,
    Zone_2_Distance number,
    Zone_3_Distance  number,
    Zone_4_Distance  number,
    Zone_5_Distance  number,
    Zone_6_Distance  number,
    Zone_7_Distance  number,
    Zone_8_Distance number,
    Hard_Running number,
    Hard_Running_Efforts number,
    Work_Rate number,
    Top_Speed number,
    Intensity number,
    Impact_Light number,
    Impact_Medium number,
    Impact_Heavy number,
    Load_2D number,
    Load_3D number,
    L1 number,
